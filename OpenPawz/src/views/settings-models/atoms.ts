...
export const TIER_LABELS: Record<string, Record<string, string>> = {
  ...
  claudecode: {
    sonnet: 'Best value — uses Max subscription, no API key needed',
    opus: 'Flagship — uses Max subscription, no API key needed',
    haiku: 'Fast + cheap — uses Max subscription, no API key needed',
  },
};

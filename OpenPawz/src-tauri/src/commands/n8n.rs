...
/// Delegates to `commands::integration_map` (always-available module).
pub(crate) fn map_integration_to_skill(
    service_id: &str,
    creds: &std::collections::HashMap<String, String>,
) -> (String, std::collections::HashMap<String, String>) {
    super::integration_map::map_integration_to_skill(service_id, creds)
}
...
pub fn service_to_skill_id(service_id: &str) -> String {
    super::integration_map::service_to_skill_id(service_id)
}

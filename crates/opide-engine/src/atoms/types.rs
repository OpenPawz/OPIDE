...
pub enum ProviderKind {
    ...
    ClaudeCode,
    /// External provider — registered by host app (e.g. OPIDE) via ProviderFactory trait.
    /// The provider implementation is supplied at runtime, not compiled into OpenPawz.
    External,
}
...
pub struct ChatRequest {
    ...
    /// Active workspace path on disk.  Used to locate OPIDE_NOTES.md for
